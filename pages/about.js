        ...
        <div className="md:flex md:items-center">
          <div className="my-8 space-y-4 md:w-1/2">
            ...
            <p className="text-lg md:text-left text-center">
              This website or platform provides learning materials for students
              all over Ghana and beyond. Providing the right materials for
              students helps them in their academic studies. That is why we are
      ...
      <div className="md:w-4/5 mx-4 md:mx-auto my-16">
        <div className="md:flex md:items-center">
          ...
          <div className="my-8 space-y-4 md:w-1/2">
            ...
            <p className="text-lg md:text-left text-center">
              We want to make it easy for students all over the world to access
              learning materials. Our aim is to provide students with past
              questions and other learning materials. In other, for them to
