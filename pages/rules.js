  ...
  return (
    <div className="space-y-4 m-8 md:w-4/5 md:mx-auto">
      ...
      <p>
        ...
        of Baba&apos;s Website, located at https:baba.io.
      </p>

      <p>
        By accessing this website we assume you accept these terms and
        conditions. Do not continue to use Baba if you do not agree to take all
      ...
      <p>
        Unless otherwise stated, Baba and/or its licensors own the intellectual
        property rights for all material on Baba. All intellectual property
        rights are reserved. You may access this from Baba for your own personal
      ...
      <p>
        ...
        exchange opinions and information in certain areas of the website. Baba
        ...
        of Baba,its agents and/or affiliates. Comments reflect the views and
        opinions of the person who post their views and opinions. To the extent
        permitted by applicable laws, Baba shall not be liable for the Comments
      ...
      <p>
        ...
        e-mail to Baba. Please include your name, your organization name,
      ...
      <p>
        No use of Baba&apos;s logo or other artwork will be allowed for linking
