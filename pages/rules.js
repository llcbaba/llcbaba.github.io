...
const Rules = () => {
  return (
    <div>
      <Head>
        <title>Baba | Rules</title>
        <meta
          name="description"
          content="terms of use of this website is provide here."
        />
        <meta
          name="keyword"
          content="Baba rules terms and conditions use page learn learning materials slides passco pass questions images university student"
        />
        <link rel="icon" href="/favicon.ico" />
      </Head>
      <div className="space-y-4 m-8 md:w-4/5 md:mx-auto">
        <h2>
        ...
        <p>
          ...
          use of Baba&apos;s Website, located at https:baba.io.
        </p>

        <p>
          By accessing this website we assume you accept these terms and
          conditions. Do not continue to use Baba if you do not agree to take
        ...
        <p>
          We employ the use of cookies. By accessing Baba, you agreed to use
          cookies in agreement with the Baba&apos;s Privacy Policy.{" "}
        </p>
        ...
        <p>
          Unless otherwise stated, Baba and/or its licensors own the
          intellectual property rights for all material on Baba. All
          intellectual property rights are reserved. You may access this from
          Baba for your own personal use subjected to restrictions set in these
          terms and conditions.
        </p>

        <p>You must not:</p>
        <ul>
          <li>Republish material from Baba</li>
          <li>Sell, rent or sub-license material from Baba</li>
          <li>Reproduce, duplicate or copy material from Baba</li>
          <li>Redistribute content from Baba</li>
        </ul>
        ...
        <p>
          ...
          Baba does not filter, edit, publish or review Comments prior to their
          presence on the website. Comments do not reflect the views and
          opinions of Baba,its agents and/or affiliates. Comments reflect the
          views and opinions of the person who post their views and opinions. To
          the extent permitted by applicable laws, Baba shall not be liable for
        ...
        <p>
          Baba reserves the right to monitor all Comments and to remove any
        ...
        <p>
          You hereby grant Baba a non-exclusive license to use, reproduce, edit
        ...
        <p>
          ...
          the hyperlink compensates the absence of Baba; and (d) the link is in
        ...
        <p>
          ...
          sending an e-mail to Baba. Please include your name, your organization
        ...
        <p>
          No use of Baba&apos;s logo or other artwork will be allowed for
